...
### **Frontend Layer**
- **Library**: `React 18` (Vite 기반 고속 빌드), `Lucide React`
- **Styling**: `Tailwind CSS` (Modern & Premium UI)
- **State**: `React Hooks`, `Context API`, `LocalStorage Persistence`
...
│   ├── src/components/ # 고도화된 UI 컴포넌트 (Onboarding, Recommendation, Calendar)
│   └── src/api/        # API 클라이언트 (Axios)
├── docs/               # 개발 리포트 및 아키텍처 문서 (1~15번 보고서)
...
- **[보고서 14]**: UX 영속성 처리 및 프로필 관리 시스템 개선
