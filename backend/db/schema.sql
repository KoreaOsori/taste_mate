...
CREATE TABLE IF NOT EXISTS profiles (
    ...
    lunch_time TEXT,
    dinner_time TEXT,
    breakfast_active BOOLEAN DEFAULT TRUE,
    lunch_active BOOLEAN DEFAULT TRUE,
    dinner_active BOOLEAN DEFAULT TRUE,
    breakfast_notify BOOLEAN DEFAULT TRUE,
    lunch_notify BOOLEAN DEFAULT TRUE,
    dinner_notify BOOLEAN DEFAULT TRUE,
    location TEXT,
